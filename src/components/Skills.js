    ...
    return (
        <div id = "skills" className="px-4 md:px-0 mx-auto md:w-[900px] space-y-2 text-white">
            ...
            <div className="border-[1px] border-gray-700 p-4 space-y-2 rounded-xl">
                <p>
                    <span className="font-semibold">Languages</span> <span className="text-gray-400">   JavaScript, TypeScript, Java, Python, C#</span> 
                </p>
                <p>
                    <span className="font-semibold">Technology</span> <span className="text-gray-400"> React.js, Next.js, Express.js, React Native, NextAuth.js, Tailwind CSS, MongoDB, MySQL, Firebase,  Unix/Linux, Github, VSCode, Vim, Algorithms, Data Structure, Data Mining</span> 
                </p>
                <p>
